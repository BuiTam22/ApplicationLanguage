...
namespace LanguageApplication
{
    public partial class EditUser : Form
    {
        ...
        public EditUser(string id, string username, string password, string name, string email, string role, ManagerAcc managerAcc)

        {
            this.manager = managerAcc;
            InitializeComponent();
